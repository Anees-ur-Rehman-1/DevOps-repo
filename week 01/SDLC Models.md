...
### Review
In this phase, after the product deployment, review phase is performed to check the behavior  and validity of the developed product. And if there are any error found then the process starts again from the requirement gathering.
### Maintenance
